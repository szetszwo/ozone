...
public class NodeStateManager implements Runnable, Closeable {
  ...
  /**
   * Replace the containers of the given datanode.
   * @throws NodeNotFoundException - if datanode is not known.
   */
  void replaceContainersForTesting(DatanodeID datanodeID, Set<ContainerID> containerIds)
      throws NodeNotFoundException {
    nodeStateMap.replaceContainersForTesting(datanodeID, containerIds);
  }
