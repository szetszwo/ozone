...
class RDBTable implements Table<byte[], byte[]> {
  ...
  @Override
  public TableIterator<byte[], KeyValue<byte[], byte[]>> iterator() throws RocksDatabaseException {
    return iterator((byte[])null);
  }

  @Override
  public TableIterator<byte[], KeyValue<byte[], byte[]>> iterator(byte[] prefix) throws RocksDatabaseException {
  ...
  TableIterator<CodecBuffer, KeyValue<CodecBuffer, CodecBuffer>> iterator(
      CodecBuffer prefix) throws RocksDatabaseException {
