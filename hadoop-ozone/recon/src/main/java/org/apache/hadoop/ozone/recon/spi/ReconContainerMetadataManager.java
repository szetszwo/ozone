...
public interface ReconContainerMetadataManager {
   ...
   */
  Table.Iterator<ContainerKeyPrefix, Integer> getContainerTableIterator() throws IOException;
   ...
   * @return TableIterator
   */
  Table.Iterator<KeyPrefixContainer, Integer> getKeyContainerTableIterator() throws IOException;
